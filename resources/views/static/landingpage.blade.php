  ...
  <section class="pb_cover_v3 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light" id="section-home">
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-md-5 relative align-self-center" style="z-index:100;">

          <form action="{{ route('register') }}" method="post" class="bg-white rounded pb_form_v1">
            {{ csrf_field() }}
            <h2 class="mb-4 mt-0 text-center">Register for Free</h2>
            @if(session()->get('status') == true)
              <center><span style="color:green;"><h5>Success!</h5></span></center>
            @else

            @endif
            <div class="row">
              <div class="form-group col">
                <input type="text" class="form-control pb_height-40 reverse" name="fname" placeholder="First name">
                <span style="color:red;">{{ $errors->first('fname') }}</span>
              </div>
              <div class="form-group col">
                <input type="text" class="form-control pb_height-40 reverse" name="lname" placeholder="Last name">
                <span style="color:red;">{{ $errors->first('lname') }}</span>
              </div>
            </div>
            <div class="form-group">
              <input type="text" class="form-control pb_height-40 reverse" name="email" placeholder="Owner Email Address">
              <span style="color:red;">{{ $errors->first('email') }}</span>
            </div>
            <div class="form-group">
              <input type="text" class="form-control pb_height-40 reverse" name="companyname" placeholder="Company name">
              <span style="color:red;">{{ $errors->first('companyname') }}</span>
            </div>
            <div class="form-group">
              <input type="text" class="form-control pb_height-40 reverse" name="link" placeholder="Company Link">
              <span style="color:red;">{{ $errors->first('link') }}</span>
            </div>
            <div class="row">
              <div class="form-group col">
                <input type="text" class="form-control pb_height-40 reverse" name="password" placeholder="Password">
                <span style="color:red;">{{ $errors->first('password') }}</span>
              </div>
              <div class="form-group col">
                <input type="text" class="form-control pb_height-40 reverse" name="password_confirmation" placeholder="Confirm Password">
                <span style="color:red;">{{ $errors->first('password_confirmation') }}</span>
              </div>
            </div>
            <input type="hidden" value="type1" name="subscription_type">
            <div class="form-group">
      ...
      <div class="row">
        <div class="col-md">
          <div class="pb_pricing_v1 p-5 border text-center bg-white">
            ...
            <p class="mb-0"><a href="#register" role="button" class="btn btn-secondary">Get started</a></p>
          </div>
        </div>
        <div class="col-md">
          <div class="pb_pricing_v1 p-5 border border-primary text-center bg-white">
            ...
            <p class="pb_font-15">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts</p>
            <p class="mb-0"><a href="#register" role="button" class="btn btn-primary btn-shadow-blue">Get started</a></p>
          </div>
        </div>
        <div class="col-md">
          <div class="pb_pricing_v1 p-5 border text-center bg-white">
      ...
      <div class="container">
        ...
        <div class="col-md-5 " id="register">
         <form action="" method="post"  class="bg-white rounded pb_form_v1">
          ...
          <div class="row">
            <div class="form-group col">
              <input type="text" class="form-control pb_height-40 reverse" name="lname" placeholder="First name">
            </div>
            <div class="form-group col">
              <input type="text" class="form-control pb_height-40 reverse" name="lname" placeholder="Last name">
            </div>
          ...
          <div class="form-group">
            <div class="pb_select-wrap">
              <select class="form-control pb_height-40 reverse">
